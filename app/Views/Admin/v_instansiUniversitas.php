...
<div class="container-fluid pb-1 p-0">
    <!-- DataTales Example -->
    <?php include(APPPATH.'Views/Admin/Modal/modalInstansi.php') ?>
    <!-- table -->
    <div class="title text-dark font-weight-bold px-1 rounded-top mt-5 pl-3">List Data Universitas</div>
    <div class="wrapperCard h-100">
        <div class="row row-cols-1 py-3 mx-auto d-flex flex-row">
            ...
            <div class="col-lg-3 d-flex align-items-center justify-content-center">
                <div class="card text-white bg-gradient-info mb-3 w-100" style="max-width: 22rem">
...
// function get_sekolah($nama_instansi) {
//     $.ajax({
//         url: "<?= site_url('admin/admin/instansi'); ?>/" + $nama_instansi,
//         type: "GET",
//         dataType: "json",
//         success: function(response) {
//             if (response.dataSekolah) {
//                 $('#instansiNama').val(response.nama_instansi);
//                 $('#instansiJumlah').val(response.jumlahSiswa);
//                 $('#instansiPendidikan').val(response.instansi_pendidikan);
//             }
//         }
//     });
// }
