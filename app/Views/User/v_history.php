            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="min-width: 150px;">Nama Lengkap</th>
                        <th class="text-center" style="min-width: 150px;">Location</th>
                        <th class="text-center" style="min-width: 100px;">Foto Absen</th>
                        ...
                        <th class="text-center" style="min-width: 180px;">Tanggal</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
